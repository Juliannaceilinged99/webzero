...
Every web server assumes you have RAM, disk IOPS, and a modern CPU.
WebZero assumes you don't. It is built for:
...
```bash
git clone https://github.com/yourusername/webzero
cd webzero
...
├── tools/
│   └── wz.js                 ← build tool (zero npm deps)
├── examples/
│   ├── blog/
│   └── landing-page/
├── bench/
